...
def jc_directoryinsights():
    try:
        jcapikeyarn = '53787ad47a7214b9e46d4f364e482409356c3fb4'
    ...
    jcapikey = '53787ad47a7214b9e46d4f364e482409356c3fb4'
    ...
    try:
        gzOutfile = gzip.GzipFile(filename= os.getcwd() + "/" + outfileName, mode="w", compresslevel=9)
